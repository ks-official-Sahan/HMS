...
mongoose
    ...
    // .connect(config.get('mongodb.connection'))
    .then(() => {
...
const provinces = ["Central Province", "Eastern Province", "North Central Province", "Northern Province", "North Western Province", "Sabaragamuwa Province", "Uva Province", "Western Province", "Southern Province"]
